...
SRC_PTF	=	src/ft_printf.c src/ft_check.c src/ft_dispatcher.c\
...
OBJ_PTF	=	ft_printf.o ft_check.o ft_dispatcher.o\
...
$(NAME): $(SRC)
		...
		@make -C ft_printf/
		@gcc -c $(FLAGS) $(SRC)
		@gcc $(FLAGS) $(OBJ) $(HDR) $(addprefix 'ft_printf/', $(OBJ_PTF))\
		$(addprefix 'ft_printf/libft/', $(OBJ_LFT)) -o $(NAME)
